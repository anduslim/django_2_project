...
class OnboardForm(forms.Form):
    ...
    helper.layout = Layout(
        Field('request_type', placeholder="Select Request Type",
            id="requesttype"),
        Field('onebankid', placeholder="Enter your 1BankID",
            id="bankid"),
        Field('username', placeholder="Enter the User ID to be created",
            id="username"),
        Field('groupname', placeholder="Enter the group to be added/created",
            id="groupname"),
