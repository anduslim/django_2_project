...
class OnBoardView(bracesviews.LoginRequiredMixin,
                 bracesviews.FormValidMessageMixin,
                 generic.CreateView):
    form_class = forms.OnboardForm
    model = User
    template_name = 'accounts/onboardform.html'
    login_url = reverse_lazy('signup')
    raise_exception = True
    success_url = reverse_lazy('home')
    form_valid_message = "Success! Please wait for your onboarding request to\
                            be approved!"
